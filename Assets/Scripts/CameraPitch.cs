...
public class CameraPitch : MonoBehaviour
{
    ...
    private float PitchInterpolation = 1000.0f; //THIS VALUE IS WAY TOO HIGH AND SHOULD BE IN THE SINGLE DIGITS
    ...
    private float MaxPitchDown = 85.0f; //Lower this to keep the camera from looking down to far (can even be negative)
    //Getter and setter so a camera hint can access it

...
public class CameraOcclusion : MonoBehaviour
{
    ...
    public float DefaultZoom = 10.0f; //THIS VALUE IS WAY TOO LARGE AND SHOULD BE IN THE 10 TO 20 RANGE
    ...
    public float TransparentZoom = 0.45f;
    ...
    public float DownwardsRotationAngle = 5.0f;
